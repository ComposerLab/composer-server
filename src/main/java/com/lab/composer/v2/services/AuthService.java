...
import com.lab.composer.v2.common.token.TokenProvider;
...
import com.lab.composer.v2.repositories.RefreshTokenRepository;
...
public class AuthService {
  ...
  @Transactional
  public TokenDto login(MemberRequestDto memberRequestDto, Roles roles) {
    ...
    TokenDto tokenDto = tokenProvider.generateTokenDto(authentication, roles);
  ...
  public TokenDto reissue(TokenRequestDto tokenRequestDto) {
    ...
    // 5. 새로운 토큰 생성
    TokenDto tokenDto = tokenProvider.generateReIssueTokenDto(authentication);
...
//  @Transactional
//  public MemberResponseDto findPassword(MemberRequestDto memberRequestDto) {
//    if (!memberRepository.existsByEmail(memberRequestDto.getEmail())) {
