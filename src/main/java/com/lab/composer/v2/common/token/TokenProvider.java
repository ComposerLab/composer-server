package com.lab.composer.v2.common.token;
...
public class TokenProvider {
  ...
  public TokenDto generateTokenDto(Authentication authentication, Roles roles) {
    // 권한들 가져오기
  ...
  public TokenDto generateReIssueTokenDto(Authentication authentication) {
    // 권한들 가져오기
    String authorities = authentication.getAuthorities().stream()
        .map(GrantedAuthority::getAuthority)
        .collect(Collectors.joining(","));
